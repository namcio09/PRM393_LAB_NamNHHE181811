...
class MovieDetailPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final favoriteViewModel = ref.read(favoriteMoviesViewModelProvider.notifier);
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  _ActionItem(
                    ...
                    label: 'Favorite',
                    iconColor: isFavorite ? Colors.redAccent : Colors.black54,
                    onTap: () => favoriteViewModel.toggleFavorite(movie.id),
                  ),
                  _ActionItem(
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                final trailerImage = movie.trailers[index];
                return Container(
